          ...
          <div class="panel-body">
            <form action="Lab10.php" method="get" class="form-horizontal">
              ...
              <select name="continent" class="form-control">
                ...
                $result=$mysqli->query("SELECT ContinentName,ContinentCode FROM continents");
              ...
              <select name="country" class="form-control">
                ...
                <?php 
                //Fill this place
                $result2=$mysqli->query("SELECT ISO,CountryName FROM countries");
		...
		<ul class="caption-style-2">
            ...
            */
            ...
            function findByCountry(){
                global $mysqli;
                $query="SELECT * FROM imagedetails WHERE CountryCodeISO='".$_GET['country']."'";
            ...
            function findByContinent(){
                global $mysqli;
                $query="SELECT * FROM imagedetails WHERE ContinentCode='".$_GET['continent']."'";
                $result3=$mysqli->query($query);
                while($row = $result3->fetch_assoc()) {
                    echo '<li>
              <a href="detail.php?id='.$row['ImageID'].'" class="img-responsive">
            ...
            function findByBoth(){
                global $mysqli;
                $query="SELECT * FROM imagedetails WHERE ContinentCode='".$_GET['continent']."' AND CountryCodeISO='".$_GET["country"]."'";
                $result3=$mysqli->query($query);
                while($row = $result3->fetch_assoc()) {
                    echo '<li>
              <a href="detail.php?id='.$row['ImageID'].'" class="img-responsive">
